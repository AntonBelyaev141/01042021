...
// Если потребуется начислять единоразовые начисления и при этом данный документ - исправление
	...
	Если ОтпускНачинаетсяВСледующемМесяце(НачалоПериода1) И Объект.ПредоставитьЕдиновременнуюВыплатуКОтпуску Тогда
	...
	Если (Объект.ПредоставитьЕдиновременнуюВыплатуКОтпуску И ЗначениеЗаполнено(Объект.ВидРасчетаЕдиновременнойВыплатыКОтпуску) 
		...
		#Вставка
		//1АБ Беляев +
		РеквизитыИсправления = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.ИсправленныйДокумент, "ПериодРегистрации,ДатаНачалаСобытия,ПредоставитьЕдиновременнуюВыплатуКОтпуску,ВидРасчетаЕдиновременнойВыплатыКОтпуску,ПредоставитьМатериальнуюПомощьПриОтпуске");
		//1АБ Беляев -
		#КонецВставки		
		...
		Если Объект.ПредоставитьЕдиновременнуюВыплатуКОтпуску И ЗначениеЗаполнено(Объект.ВидРасчетаЕдиновременнойВыплатыКОтпуску) 
			...
			#Вставка
			//1АБ Беляев +
			ПериодРегистрацииЕдиновременнойВыплаты = НачалоМесяца(РеквизитыИсправления.ДатаНачалаСобытия);
			//1АБ Беляев -
			#КонецВставки			
		КонецЕсли;
