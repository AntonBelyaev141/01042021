...
&ИзменениеИКонтроль("РассчитатьНалогДо2025Года")
Функция АБ_РассчитатьНалогДо2025Года(ИсключаемыйРегистратор, Организация, МесяцРасчета, Знач СписокФизическихЛиц, Знач ПервыйМесяцНалоговогоПериода = Неопределено, Знач ПоследнийМесяцНалоговогоПериода = Неопределено, Знач ОкончательныйРасчет = Истина, Знач ДатаУдержанияИсчисленногоНалога = Неопределено, ДвиженияТекущегоРегистратора = Неопределено) Экспорт	
	#Вставка
...
&ИзменениеИКонтроль("РассчитатьНалогДо2023Года")
Функция АБ_РассчитатьНалогДо2023Года(ИсключаемыйРегистратор, Организация, МесяцРасчета, Знач СписокФизическихЛиц, Знач ПервыйМесяцНалоговогоПериода = Неопределено, Знач ПоследнийМесяцНалоговогоПериода = Неопределено, Знач ОкончательныйРасчет = Истина, ДатаУдержанияИсчисленногоНалога = Неопределено, ДвиженияТекущегоРегистратора = Неопределено) Экспорт	
	#Вставка
	//1АБ Беляев 14.03.2021 +
	Если НЕ ТипЗнч(ДвиженияТекущегоРегистратора)=Тип("Неопределено") И ДвиженияТекущегоРегистратора.Свойство("АБ_НеПредоставлятьВычеты") Тогда
	АБ_НеПредоставлятьВычеты=ДвиженияТекущегоРегистратора.АБ_НеПредоставлятьВычеты;
...
&ИзменениеИКонтроль("РассчитатьНалогПоПлоскойСтавке")
Функция АБ_РассчитатьНалогПоПлоскойСтавке(ИсключаемыйРегистратор, Организация, МесяцРасчета, Знач СписокФизическихЛиц, Знач ПервыйМесяцНалоговогоПериода, Знач ПоследнийМесяцНалоговогоПериода, ОкончательныйРасчет, ДатаУдержанияИсчисленногоНалога, ДвиженияТекущегоРегистратора, ОграничиватьНалоговыйПериод = Ложь)
	#Вставка
	//1АБ Беляев 14.03.2021 +
	Если НЕ ТипЗнч(ДвиженияТекущегоРегистратора)=Тип("Неопределено") И ДвиженияТекущегоРегистратора.Свойство("АБ_НеПредоставлятьВычеты") Тогда
	АБ_НеПредоставлятьВычеты=ДвиженияТекущегоРегистратора.АБ_НеПредоставлятьВычеты;
